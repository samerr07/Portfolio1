...
const Contact = () => {
  return (
    <div name='contact' className='z-50 bg-gray-800 relative py-10 px-5 md:px-0'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
            <div className='md:w-1/2 mb-8 ml-2 md:mb-0'>
              ...
              <div className='flex space-x-4'>
                ...
                <a target='_blank' href="https://github.com/samerr07" className='text-foreground/60 hover:text-foreground/80'>
                <img src={github} alt="" className='h-6 w-6'/></a>
                <a target='_blank' href="https://www.linkedin.com/in/sameer-srivastava-7896b8208/" className='text-foreground/60 hover:text-foreground/80'>
                <img src={linkedin} alt="" className='h-6 w-6'/></a>
              </div>
                <Lottie animationData={contact} className='w-[350px] mx-auto lg:w-[500px]'/>
            </div>
            <form smooth duration={500} className='w-full md:w-1/2 bg-gray-100 rounded-lg border border-red-300 shadow-lg shadow-red-500 p-10'> 
