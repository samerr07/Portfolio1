            ...
            <div className='bg-gray-100 py-12'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center'>
                        ...
                        <p className='mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl'>Hi, I'm Sameer Srivastava</p>
                    ...
                    <div className='mt-12'>
                        ...
                        <p className='mt-4 text-lg text-gray-600'>
                        Beyond coding, I am passionate about exploring new technologies and staying up-to-date with the latest trends in web development. I enjoy solving real-world problems through innovative solutions and continuously strive to improve my skills. In my free time, I love experimenting with new tools and frameworks to enhance my expertise and creativity in building impactful projects.
                        </p>
                    </div>
                </div>
            </div>
